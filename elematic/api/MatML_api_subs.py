...
class AssociationDetailsSub(supermod.AssociationDetails):
    def __init__(self, Associate=None, Relationship=None, Notes=None, **kwargs_):
        super(AssociationDetailsSub, self).__init__(
            Associate, Relationship, Notes, **kwargs_
        )
...
class BulkDetailsSub(supermod.BulkDetails):
    def __init__(
        ...
        **kwargs_
        ...
        super(BulkDetailsSub, self).__init__(
            Name,
            Class,
            Subclass,
            Specification,
...
class CharacterizationSub(supermod.Characterization):
    def __init__(
        ...
        DimensionalDetails=None,
        Notes=None,
        **kwargs_
    ):
        super(CharacterizationSub, self).__init__(
            Formula,
            ChemicalComposition,
            PhaseComposition,
            DimensionalDetails,
...
class ComponentDetailsSub(supermod.ComponentDetails):
    def __init__(
        ...
        Characterization=None,
        PropertyData=None,
        AssociationDetails=None,
        ComponentDetails_member=None,
        **kwargs_
    ):
        super(ComponentDetailsSub, self).__init__(
            id,
            Name,
            Class,
            Subclass,
...
class ConcentrationSub(supermod.Concentration):
    def __init__(
        ...
        **kwargs_
        ...
        super(ConcentrationSub, self).__init__(
            Value, Units, Qualifier, Uncertainty, Notes, **kwargs_
        )
...
class DimensionalDetailsSub(supermod.DimensionalDetails):
    def __init__(
        ...
        **kwargs_
        ...
        super(DimensionalDetailsSub, self).__init__(
            Name, Value, Units, Qualifier, Uncertainty, Notes, **kwargs_
        )
...
class GeometrySub(supermod.Geometry):
    def __init__(
        self, Shape=None, Dimensions=None, Orientation=None, Notes=None, **kwargs_
    ):
        super(GeometrySub, self).__init__(
            Shape, Dimensions, Orientation, Notes, **kwargs_
        )
...
class GlossaryTermSub(supermod.GlossaryTerm):
    def __init__(
        ...
        **kwargs_
        ...
        super(GlossaryTermSub, self).__init__(
            Name, Definition, Abbreviation, Synonym, Notes, **kwargs_
        )
...
class MaterialSub(supermod.Material):
    def __init__(
        ...
        id=None,
        layers=None,
        local_frame_of_reference=None,
        BulkDetails=None,
        ComponentDetails=None,
        Graphs=None,
        Glossary=None,
        **kwargs_
    ):
        super(MaterialSub, self).__init__(
            id,
            layers,
...
class MetadataSub(supermod.Metadata):
    def __init__(
        self,
        AuthorityDetails=None,
        DataSourceDetails=None,
        MeasurementTechniqueDetails=None,
        ParameterDetails=None,
        PropertyDetails=None,
        SourceDetails=None,
        SpecimenDetails=None,
        TestConditionDetails=None,
        **kwargs_
    ):
        super(MetadataSub, self).__init__(
            AuthorityDetails,
            DataSourceDetails,
...
class ParameterValueSub(supermod.ParameterValue):
    def __init__(
        ...
        **kwargs_
        ...
        super(ParameterValueSub, self).__init__(
            parameter, format, Data, Uncertainty, Qualifier, Notes, **kwargs_
        )
...
class PhaseCompositionSub(supermod.PhaseComposition):
    def __init__(
        self, Name=None, Concentration=None, PropertyData=None, Notes=None, **kwargs_
    ):
        super(PhaseCompositionSub, self).__init__(
            Name, Concentration, PropertyData, Notes, **kwargs_
        )
...
class ProcessingDetailsSub(supermod.ProcessingDetails):
    def __init__(
        self, Name=None, ParameterValue=None, Result=None, Notes=None, **kwargs_
    ):
        super(ProcessingDetailsSub, self).__init__(
            Name, ParameterValue, Result, Notes, **kwargs_
        )
...
class PropertyDataSub(supermod.PropertyData):
    def __init__(
        ...
        **kwargs_
        ...
        super(PropertyDataSub, self).__init__(
            property,
            technique,
            source,
            specimen,
...
class UncertaintySub(supermod.Uncertainty):
    def __init__(
        self,
        DistributionType="Normal/Gaussian",
        Num_Std_Dev=2,
        Percentile=None,
        ...
        **kwargs_
        ...
        super(UncertaintySub, self).__init__(
            DistributionType,
            Num_Std_Dev,
            Percentile,
            ConfidenceLevel,
...
class UnitSub(supermod.Unit):
    def __init__(
        self, power=None, description=None, Name=None, Currency=None, **kwargs_
    ):
...
class UnitsSub(supermod.Units):
    def __init__(
        ...
        **kwargs_
        ...
        super(UnitsSub, self).__init__(
            system, factor, name, description, Unit, **kwargs_
        )
...
class ParameterDetailsSub(supermod.ParameterDetails):
    def __init__(
        self, id=None, Name=None, Units=None, Unitless=None, Notes=None, **kwargs_
    ):
        super(ParameterDetailsSub, self).__init__(
            id, Name, Units, Unitless, Notes, **kwargs_
        )
...
class PropertyDetailsSub(supermod.PropertyDetails):
    def __init__(
        ...
        **kwargs_
        ...
        super(PropertyDetailsSub, self).__init__(
            id, type_, Name, Units, Unitless, Notes, **kwargs_
        )
...
class SpecimenDetailsSub(supermod.SpecimenDetails):
    def __init__(
        self, id=None, type_=None, Name=None, Notes=None, Geometry=None, **kwargs_
    ):
        super(SpecimenDetailsSub, self).__init__(
            id, type_, Name, Notes, Geometry, **kwargs_
        )
...
class TestConditionDetailsSub(supermod.TestConditionDetails):
    def __init__(self, id=None, ParameterValue=None, Notes=None, **kwargs_):
        super(TestConditionDetailsSub, self).__init__(
            id, ParameterValue, Notes, **kwargs_
        )
